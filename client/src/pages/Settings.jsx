      ...
      <div className="space-y-5">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="card p-6"
            ...
            <p className="text-sm text-slate-500 font-medium mb-5">
              ...
              <span className="block mt-1.5 text-amber-700 font-bold text-xs">WhatsApp integration configuration (Phase 2)</span>
            </p>
            ...
            <div className="mt-5 flex items-center gap-3">
              ...
              <div>
                <span className="text-sm font-bold text-slate-800">Enable Notifications</span>
                <p className="text-[11px] text-slate-500 font-medium">Receive WhatsApp reminders for upcoming renewals</p>
              </div>
            </div>
        ...
        >
          ...
          <button
            disabled
            title="Coming soon"
            className="bg-rose-50 border border-rose-100 text-rose-300 rounded-xl px-5 py-2.5 text-sm cursor-not-allowed font-semibold"
          >
            Delete Account
          </button>
        </div>
